def Setup(Settings,DefaultModel):
    # set8backinexpansionism/expand_lr_markable_kfold.py
    # probably ANOTHER 6GB

    Settings["experiment_name"] = "expand_lr_markable_kfold"
    ...
    target_dataset = "5556x_markable_640x640_2x_expanded_lr"
    pixels = 640
    epochs = 500
