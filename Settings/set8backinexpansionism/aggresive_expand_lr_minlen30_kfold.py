def Setup(Settings,DefaultModel):
    # set8backinexpansionism/aggresive_expand_lr_minlen30_kfold.py


    Settings["experiment_name"] = "aggresive_expand_lr_minlen30_kfold"
    ...
    target_dataset = "5556x_minlen30_640px_2x_agressive_expanded_lr"
    pixels = 640
    epochs = 500
