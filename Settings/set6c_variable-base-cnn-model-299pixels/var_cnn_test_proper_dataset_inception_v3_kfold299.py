def Setup(Settings,DefaultModel):
    # set6_variable-base-cnn-model-short-runs/var_cnn_test_proper_dataset_inception_v3_kfold299.py
    
    Settings["experiment_name"] = "var_cnn_test_proper_dataset_inception_v3_kfold299"
