def Setup(Settings,DefaultModel):
    # set6_variable-base-cnn-model/var_cnn_test_proper_dataset_xception_kfold_4x50.py
    
    Settings["experiment_name"] = "var_cnn_test_proper_dataset_xception_kfold_4x50"
