def Setup(Settings,DefaultModel):
    # finetune_tests_varB.py

    Settings["experiment_name"] = "Finetuning-tests_big_cca_10hrs_experiment_1k50_varB-cookOnSpot-162"

    Settings["graph_histories"] = ['together'] #['all','together',[],[1,0],[0,0,0],[]]

    n = 0
    Settings["models"][n]["model_type"] = 'simple_cnn_with_top'
    Settings["models"][n]["unique_id"] = '1k50_varB-cookOnSpot-162'
