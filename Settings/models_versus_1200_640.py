def Setup(Settings,DefaultModel):
    Settings["experiment_name"] = "Comparison_of_models_1200_640"

    Settings["graph_histories"] = ['together', [0,1], [1,2], [0,2]] #['all','together',[],[1,0],[0,0,0],[]]
    n=0

    Settings["models"][n]["dataset_name"] = "1200x_markable_640x640" # "1200x_markable_299x299", "5556x_mark_res_299x299", "5556x_markable_640x640"
