def Setup(Settings, DefaultModel):
    # set4b_pixel299-tests/set4b_pixelSize_mix_299_d7.py

    Settings["experiment_name"] = "set4b_pixelSize_mix_299_d7"
    ...
    Settings["models"][n]["model_type"] = 'img_osm_mix' # osm_only simple_cnn_with_top img_osm_mix
    Settings["models"][n]["unique_id"] = 'mix_with_299'
