def Setup(Settings,DefaultModel):
    # set2_for_results/expand_dataset_forserver_normalmarkable_kfold_forcomparison.py


    Settings["experiment_name"] = "ExpandDataset_5556x_markable_640x640_kfold10_originalComparison"
