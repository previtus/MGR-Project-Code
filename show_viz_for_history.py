...
f1 = '/home/ekmek/Documents/Serverside Log results/640x640/3th-11-53_resnet50-640/history_resnet50.npy'
h = loadHistory(f1)
...
f2 = '/home/ekmek/Documents/Serverside Log results/299x299results/29th-18-19_resnet50/history_resnet50.npy'
visualize_histories([loadHistory(f1), loadHistory(f2)], ['640x640', '299x299'], show=True, save=False, save_path='')
