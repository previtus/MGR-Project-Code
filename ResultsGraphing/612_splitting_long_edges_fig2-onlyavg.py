...
from ResultsGraphing.custom import visualize_special_histories_custom, count_averages, draw_items_for_legend, onefrom, draw_normal_data, draw_titles_legends, draw_avg_data, save_plot, plot_only_averages, finally_show
...
out_folder = dir_folder + '/graphs/6.1.2. splitting long edges - minlen/fig2_average_valerr'
